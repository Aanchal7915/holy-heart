        ...
        <div className="bg-white shadow-xl rounded-2xl p-6">
          ...
          <ul className="space-y-3">
            {certifications.map((item, index) => (
              <li key={index} className="flex items-center gap-2 text-gray-700 bg-green-100/20 p-2 md:p-4 rounded hover:bg-green-300/20 transition-colors duration-300">
        ...
        <div className="bg-white shadow-xl rounded-2xl p-6">
          ...
          <ul className="space-y-3">
            {memberships.map((item, index) => (
              <li key={index} className="flex items-center gap-2 text-gray-700 bg-blue-100/20 p-2 md:p-4 rounded hover:bg-blue-300/20 transition-colors duration-300">
